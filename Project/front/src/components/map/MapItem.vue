<template>
    ...
    <div class="select-box">
        <div>
            <label style="margin: 5px;" for="sido">시/도 선택 : </label>
        ...
        <div>
            <label style="margin: 5px;"  for="gungu">시/군/구 선택 : </label>
        ...
        <div>
            <label style="margin: 5px;"  for="select-bank">은행 선택 : </label>
        ...
        <div>
            <label style="margin: 5px;"  for="keyword">키워드 : </label>
...
watch([selectedSido, selectedGungu, selectedBank], () => {
    totalKeyword.value = selectedSido.value + ' ' + selectedGungu.value + ' ' + selectedBank.value
})
...
function displayPlaces(places) {
    ...
    //     latitude.value = position.La
    //     longitude.value = position.Ma
