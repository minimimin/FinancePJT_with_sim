    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deposit_products', models.ManyToManyField(blank=True, to='financial_products.depositproduct')),
                ('loan_home_products', models.ManyToManyField(blank=True, to='financial_products.loanforhome')),
                ('saving_products', models.ManyToManyField(blank=True, to='financial_products.savingproduct')),
